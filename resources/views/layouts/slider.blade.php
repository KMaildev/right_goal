<div class="banner-slider-area-two" style="background-color:#f9f9fe;">
    <div class="banner-slider-two owl-carousel owl-theme">
        <div class="banner-slider-two-item">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="banner-slider-two-content">
                    ...
                    <div class="col-lg-5 pe-0">
                        <div class="banner-slider-two-img">
